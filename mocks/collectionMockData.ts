...
export const collectionMockData: Collection[] = [
  {
    ...
    destination: "제주도",
    memberCount: 4,
    members: ["멤버 A", "멤버 B", "멤버 C", "멤버 D"],
    thumbnailImageUrl: "https://placehold.co/600x300/FFFFFF/FFFFFF.png",
    places: [
      {
        placeName: "성산일출봉",
        placeDescription:
          "유네스코 세계자연유산으로 지정된 화산체로, 일출 명소로 유명합니다.",
      ...
      },
      {
        placeName: "카멜리아힐",
        placeDescription:
          "세계적인 동백나무 식물원으로 사계절 다양한 꽃을 감상할 수 있습니다.",
      ...
      },
      {
        placeName: "협재 해수욕장",
        placeDescription:
          "에메랄드 빛 바다와 하얀 모래사장이 아름다운 해수욕장입니다.",
    ...
    places: [
      {
        placeName: "해동용궁사",
        placeDescription:
          "바다 위에 지어진 절로, 바다와 산의 조화가 아름다운 곳입니다.",
      ...
      },
      {
        placeName: "감천문화마을",
        placeDescription:
          "산자락을 따라 빼곡히 들어선 집들이 마치 산타마을을 연상시키는 문화마을입니다.",
      ...
      },
      {
        ...
        placeDescription:
          "부산을 대표하는 해수욕장으로 다양한 이벤트와 축제가 열리는 곳입니다.",
      ...
      },
      {
        placeName: "자갈치시장",
        placeDescription:
          "부산 최대의 수산물 전문 시장으로 신선한 해산물을 구입할 수 있습니다.",
  ...
  },
  {
    ...
    destination: "강릉",
    memberCount: 3,
    members: ["멤버 A", "멤버 B", "멤버 C"],
    thumbnailImageUrl: "https://placehold.co/600x300/FFFFFF/FFFFFF.png",
    places: [
      {
        placeName: "안목해변",
        placeDescription:
          "강릉의 대표적인 해변으로 커피거리와 함께 즐길 수 있는 곳입니다.",
      ...
      },
      {
        placeName: "하슬라아트월드",
        placeDescription:
          "자연과 예술이 만나는 공간으로 다양한 미술 작품을 감상할 수 있습니다.",
