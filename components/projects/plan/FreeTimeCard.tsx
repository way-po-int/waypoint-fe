...
const FreeTimeCard = ({ memo }: FreeTimeCardProps) => {
  return (
    <Card className="h-[116px] w-[312px] gap-0 rounded-lg border border-[#E2E8F0] bg-[#FFFFFF] p-0 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]">
      <CardHeader className="flex h-[72px] w-[312px] items-center justify-between p-6">
      ...
      <CardContent className="flex h-[44px] w-[312px] flex-col gap-2 px-6 pb-6 pt-0">
